<?php
	...
	$sliderMainSettings->addRadio("slider_type", array("fixed"=>"Fixed","responsitive"=>"Responsive","fullwidth"=>"Full Width"),"Slider Type","fullwidth");
	
	$paramsSize = array("width"=>940,"height"=>400);
