...
//        $content .= '</div>';
    ...
    private function get_slider_list()
    {
        ...
        foreach ($sliders as $i => $slider) {
            ...
            $content .= '<div class="row-actions"><span class="edit"><a title="Edit" href="' . $edit_url . '">Edit</a> | </span><span class="delete"><a class="fsm-delete-slider" href="' . $delete_url . '">Delete</a></span></div>';
            $content .= '</td>';
                    ...
                    if ($slide_type == 'img') {
                        ...
                        if ($image) {
                            ...
                            if (empty($slide_link)) {
                                ...
                                $content .= "<a href=\"$slide_link\"><img src=\"$image\" alt=\"\"></a>\n";
                            }

                            if ($has_caption) {
                                $content .= "<div class=\"flex-caption\">\n";
                                if (!empty($slide_caption_title)) {
                                    $slide_caption_title = do_shortcode($slide_caption_title);
