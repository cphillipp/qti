...
class Inc_Import_Manager_Plugin extends Abstract_Plugin
{
    ...
    function render()
    {
        ...
        echo '<p>This plugin has been tested several times on our local environment (WordPress 3.5.x) and it works OK. We cannot guarantee that the import will work without problems in your case. This depends on your environment (database, WordPress version) settings.</p>';
