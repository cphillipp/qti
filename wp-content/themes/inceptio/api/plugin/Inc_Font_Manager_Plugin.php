...
class Inc_Font_Manager_Plugin extends Abstract_Plugin
{
    ...
    function render()
    {
        ...
        echo '<h2>Inception - ' . __('Font Manager', INCEPTIO_THEME_NAME) . ' <a class="thickbox add-new-h2" href="admin-ajax.php?action=font-manager-form" title="' . __('Add New Font', INCEPTIO_THEME_NAME) . '">' . __('Add New', INCEPTIO_THEME_NAME) . '</a></h2>';
