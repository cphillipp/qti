...
class Inc_Button_Shortcode extends Abstract_Inc_Shortcode implements Inc_Shortcode_Designer
{
    ...
    function render($attr, $inner_content = null, $code = "")
    {
        extract(shortcode_atts(array(
            ...
            Inc_Button_Shortcode::$TARGET_ATTR => '',
            Inc_Button_Shortcode::$REL_ATTR => ''), $attr));

        $target_attr = $this->get_attribute('target', $target);
        $href_attr = $this->get_attribute('href', $href);
        $rel_attr = $this->get_attribute('rel', $rel);
        ...
        return "<a class=\"$class_attr_value\" $href_attr $target_attr $rel_attr>$inner_content</a>";
    }
