...
class Inc_Image_Shortcode extends Abstract_Inc_Shortcode implements Inc_Shortcode_Designer
{
    ...
    function render($attr, $inner_content = null, $code = '')
    {
        ...
        if ($caption == 'inherited') {
            ...
            if($post){
                $caption = apply_filters('get_the_excerpt', $post->post_excerpt);
                if($title == "inherited"){
        ...
        if (empty($caption)) {
            ...
            if(!empty($href)){
                $class .= " link-overlay";
                $content .= "<a class=\"$class\" href=\"$href\" title=\"$title\">";
                $content .= "<span class=\"overlay\"></span>";
                $content .= "<img src=\"$img_src\" alt=\"\">";
                $content .= "</a>";
            }else if($lightbox == 'true'){
                $class .= " lightbox";
                $content .= "<a class=\"$class\" href=\"$full_img_src\" rel=\"$rel\" title=\"$title\"><span class=\"overlay zoom\"></span><img src=\"$img_src\" alt=\"\"></a>";
            }else{
                $content .= "<div class=\"$class\">";
                $content .= "<img src=\"$img_src\" alt=\"\" title=\"$title\">";
                $content .= "</div>";
            }
        } else {
            if ($caption_type == 'inner') {
                ...
                if (!empty($href)) {
                    ...
                    $class .= " lightbox";
                    $content .= "<a class=\"$class\" href=\"$full_img_src\" rel=\"$rel\" title=\"$title\">";
                ...
                if (!empty($href)) {
                    $content .= "<a class=\"entry-image link-overlay\" href=\"$href\" title=\"$title\">";
                    $content .= "<span class=\"overlay\"></span>";
                    $content .= "<img src=\"$img_src\" alt=\"\">";
                    $content .= "</a>";
                }else if($lightbox == 'true'){
                    $content .= "<a class=\"entry-image lightbox\" href=\"$full_img_src\" rel=\"$rel\" title=\"$title\">";
                    $content .= "<span class=\"overlay zoom\"></span>";
                    $content .= "<img src=\"$img_src\" alt=\"\">";
                    $content .= "</a>";
                } else {
                    $content .= "<div class=\"entry-image\"><img src=\"$img_src\" alt=\"\" title=\"$title\"></div>";
                }
