...
class Inc_Pricing_Table_Shortcodes extends Abstract_Inc_Shortcode implements Inc_Shortcode_Designer
{
    ...
    {
        array_push($this->boxes, new Inc_Pricing_Table_Box($attr, $inner_content));
    }
...
class Inc_Pricing_Table_Box
{
    ...
    {
        extract(shortcode_atts(array(
            Inc_Pricing_Table_Shortcodes::$COLUMN_TITLE_ATTR => '',
            Inc_Pricing_Table_Shortcodes::$COLUMN_PRICE_ATTR => '',
            Inc_Pricing_Table_Shortcodes::$COLUMNS_UNIT_ATTR => '',
            Inc_Pricing_Table_Shortcodes::$COLUMNS_ORDER_TEXT_ATTR => '',
            Inc_Pricing_Table_Shortcodes::$COLUMNS_ORDER_URL_ATTR => ''), $this->attr));
