            ...
            if ($columns == 1) {
                ...
                for ($i = 0; $i < count($img_ids); $i++) {
                    ...
                    if ($post) {
                        ...
                        $content .= "<a class=\"$li_class\" rel=\"$gallery_name\" href=\"$full_src\" title=\"$title\"><span class=\"overlay zoom\"></span><img src=\"$thumb_src\" alt=\"\"></a>";
                    }
                }
                $content .= "</div>";
            } else {
                ...
                for ($i = 0; $i < count($img_ids); $i++) {
                    ...
                    $content .= "[img src=\"$img_id\" title=\"inherited\" size=\"$size\" lightbox=\"$lightbox\" rel=\"$gallery_name\" caption_type=\"$caption_type\" $caption_attr][/img]";
                    $col++;
                }
...
class Inc_Gallery_Item
{
    ...
    function get_img($columns, $col_no, $gallery_name, $size, $lightbox, $display_caption, $caption_type)
    {
        ...
        if ($columns == 1) {
            ...
            return "<a class=\"$a_class\" rel=\"$gallery_name\" href=\"$full_src\" title=\"$title\"><span class=\"overlay zoom\"></span><img src=\"$thumb_src\" alt=\"\"></a>";
        } else {
            if ($display_caption == 'true') {
