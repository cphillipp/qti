...
class Inc_Latest_Tweets_Widget extends Abstract_Inc_Widget
{
    ...
    function form($instance)
    {
        ...
        $id_label = $username_label . ' (<a href="' . site_url() . '/wp-admin/themes.php?page=inceptio-theme-options&amp;tab=social-settings&amp;expand=configuration" target="_blank">' . $change_label . '</a>)';
