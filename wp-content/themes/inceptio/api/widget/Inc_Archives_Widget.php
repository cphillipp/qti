...
class Inc_Archives_Widget extends WP_Widget_Archives
{
    ...
    function widget($args, $instance)
    {
        ...
        if ($d) {
            ...
            echo '<select name="archive-dropdown" onchange="document.location.href=this.options[this.selectedIndex].value;"> <option value="">' . __('Select Month', INCEPTIO_THEME_NAME) . '</option> ' . $options . ' </select>';
        } else {
            echo '<ul class="menu">' . "\n";
