...
<div id="wrap">
    ...
    <header id="header">
        <div class="container clearfix">
            <!-- begin logo -->
            <h1 id="logo"><a href="<?php echo get_home_url(); ?>"><img src="<?php echo inc_get_header_logo(); ?>" alt="<?php echo inc_get_header_logo_alt(); ?>"></a></h1>
            <!-- end logo -->
            ...
            <div class="nav-wrap clearfix">
                ...
                <form id="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get">
                    <input id="s" type="text" name="s" placeholder="<?php _e('Search', INCEPTIO_THEME_NAME) ?> &hellip;" style="display: none;">
