...
if (!function_exists('inc_posts_archive_title')) {
    ...
    {
        if (is_day()) {
            return sprintf (__('Daily Archives: %s', INCEPTIO_THEME_NAME), get_the_date());
        } elseif (is_month()) {
            return sprintf (__('Monthly Archives: %s', INCEPTIO_THEME_NAME), get_the_date(_x('F Y', 'monthly archives date format', INCEPTIO_THEME_NAME)));
        } elseif (is_year()) {
            return sprintf (__('Yearly Archives: %s', INCEPTIO_THEME_NAME), get_the_date(_x('Y', 'yearly archives date format', INCEPTIO_THEME_NAME)));
        } else {
