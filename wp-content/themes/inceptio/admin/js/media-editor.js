...
jQuery(document).ready(function ($) {
    ...
    if (postTypeInput.length > 0) {
        ...
        sliderEditorButton.bind('click', function () {
            return AdminUtil.openThickBoxDialog(this, {width:450, height:200}, function () {
                ...
                sliderTypeSelector.bind('change', function () {
                    if (this.value === 'none') {
                ...
                saveFormButton.bind('click', function () {
                ...
                $('#page-slider-editor-form-cancel').bind('click', function () {
                    return tb_remove();
                });
            });
        });
        ...
        if (postType === 'page') {
            ...
            if (pageTemplateSelector.length > 0) {
                ...
                var showOrHidePageSliderEditorButton = function() {
                    ...
                    if (selectedOption) {
                        ...
                        }else if (selectedOptionVal.indexOf('overview') >= 0) {
                ...
                contactEditorButton.bind('click', function () {
                    return AdminUtil.openThickBoxDialog(this, {width:550, height:300}, function () {
                        ...
                        displayMapButton.bind('change', function () {
                            if ($(this).is(':checked')) {
                        ...
                        locTypeSelector.bind('change', function () {
                        ...
                        $('#page-contact-editor-form-cancel').bind('click', function () {
                            return tb_remove();
                        });
                    });
                });

                postsOverviewSettingsEditorButton.bind('click', function(){
                    return AdminUtil.openThickBoxDialog(this, {width:550, height:300}, function () {
                        ...
                        $('#posts-overview-editor-form-cancel').bind('click', function () {
                            return tb_remove();
                        });
                    });
                });
            ...
            videoEditorButton.bind('click', function () {
                return AdminUtil.openThickBoxDialog(this, {width:550, height:300}, function () {
                    ...
                    $('#page-video-editor-form-cancel').bind('click', function () {
                        return tb_remove();
                    });
                });
            });
